...
from .cnnG import random_conv_block, random_conv_layer, random_pooling, random_dense_block, random_conv_layer_type # type: ignore
...
def produce_all_morphs(arch: CnnArchitecture) -> List[CnnArchitecture]:
    ...
    morphs = []
    # arch2 = deepcopy(parent)
    # morphs.append(Discrete('sample', parent['sample']))
